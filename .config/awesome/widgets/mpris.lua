...
local function worker(user_args)
    ...
    local path_to_icons = '/home/eugene/.icons/Arc'

    local pause_icon = args.pause_icon or path_to_icons .. '/actions/symbolic/media-playback-pause-symbolic.svg'
    local play_icon = args.play_icon or path_to_icons .. '/actions/symbolic/media-playback-start-symbolic.svg'
    local stop_icon = args.stop_icon or path_to_icons .. '/actions/symbolic/media-playback-stop-symbolic.svg'
    local library_icon = args.library_icon or path_to_icons .. '/places/symbolic/folder-music-symbolic.svg'
    local popup_width = args.popup_width or 300

    playerctl.player_name = args.default_player or 'chromium'
    ...
    local right_padding_metadata_widget = wibox.widget {
        widget = metadata_widget,
        right = 1,
